...
Author       : Wu Chu Peng
Description  : In this program, we will print a number to console. In C language, there are value to store the value 
               you want to store. So we create a value, which type is integer. And we assign a number to it. At last 
